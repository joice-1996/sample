...
<?php
	$empidErr=$fnameErr=$mnameErr= $lnameErr=$desigErr=$emailErr=$passwordErr="";
	$emp_id=$fname=$mname=$lname=$desig=$email=$password="";
		...
		empty($desigErr)&&empty($emailErr)&&empty($passwordErr))
		{
			...
			if(mysqli_query($mysql,$sql))
			 ...
			 $sql2="insert into faculty_details(emp_id,fac_fname,fac_mname,fac_lname,login_id,
					designation)values('$emp_id','$fname','$mname','$lname',
					'$login_id','$desig')";
